...
output "http_alb_listener_blue_id" {
  value       = join("", aws_lb_listener.http_blue.*.id)
  description = "The ARN of the HTTP listener (matches arn)"
}

output "http_alb_listener_green_id" {
  value       = join("", aws_lb_listener.http_green.*.id)
  description = "The ARN of the HTTP listener (matches arn)"
}

output "http_alb_listener_blue_arn" {
  value       = join("", aws_lb_listener.http_blue.*.arn)
  description = "The ARN of the HTTP listener (matches id)"
}

output "http_alb_listener_green_arn" {
  value       = join("", aws_lb_listener.http_green.*.arn)
  description = "The ARN of the HTTP listener (matches id)"
}
...
output "alb_target_group_blue_id" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_blue.*.id)
  description = "The ARN of the Target Group (matches arn)"
}

output "alb_target_group_green_id" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_green.*.id)
  description = "The ARN of the Target Group (matches arn)"
}

output "alb_target_group_blue_arn" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_blue.*.arn)
  description = "The ARN of the Target Group (matches id)"
}

output "alb_target_group_green_arn" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_green.*.arn)
  description = "The ARN of the Target Group (matches id)"
}

output "alb_target_group_blue_arn_suffix" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_blue.*.arn_suffix)
  description = "The ARN suffix for use with CloudWatch Metrics."
}

output "alb_target_group_green_arn_suffix" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_green.*.arn_suffix)
  description = "The ARN suffix for use with CloudWatch Metrics."
}

output "aws_lb_target_group_blue_name" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_blue.*.name)
  description = "The name of the Target Group."
}

output "aws_lb_target_group_green_name" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_green.*.name)
  description = "The name of the Target Group."
}

output "alb_target_group_blue_port" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_blue.*.port)
  description = "The port of the Target Group."
}

output "alb_target_group_green_port" {
  value       = join("", aws_lb_target_group.aws_lb_target_group_green.*.port)
  description = "The port of the Target Group."
}
######################################################################
...
output "http_alb_listener_rule_blue_id" {
  value       = join("", aws_lb_listener_rule.http_blue.*.id)
  description = "The ARN of the HTTP rule (matches arn)"
}

output "http_alb_listener_rule_green_id" {
  value       = join("", aws_lb_listener_rule.http_green.*.id)
  description = "The ARN of the HTTP rule (matches arn)"
}

output "http_alb_listener_rule_blue_arn" {
  value       = join("", aws_lb_listener_rule.http_blue.*.arn)
  description = "The ARN of the HTTP rule (matches id)"
}

output "http_alb_listener_rule_green_arn" {
  value       = join("", aws_lb_listener_rule.http_green.*.arn)
  description = "The ARN of the HTTP rule (matches id)"
}
